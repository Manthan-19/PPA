...
int demo::i = 10;	//Initialize the static variable. We can't initialize it inside a constructor.

class extra : public demo
{
	public :
		extra()
		{
		...
		{
			pro = 35;
			cout<<endl<<"public member : "<<pub<<endl<<"Protected member : "<<pro<<endl;
		}
};
int main()
{
	...
	extra eobj;		// 'obj' is declared of type demo class i.e. object declaration done ...
...
*/	
	...
	cout<<"Public member : "<<eobj.pub; 		// output : Public member : 10


	cout<<endl<<endl<<"Accessing all the class members using the fun..";
	eobj.fun();				// output : public member : 10
							//			Private member : 20
							//			Protected member : 30

	eobj.gun();				// output : public member : 10
							//			Protected member : 35		
